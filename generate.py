...
ZAKEN = [
    {
        ...
        "verdachten": [V("Sam", "🧑"), V("Lisa", "👧"), V("Tim", "👦")],
        "plaatsen": [V("Sporthal", "🏐"), V("Bibliotheek", "📚"), V("Bakkerij", "🥐")],
        "voorwerpen": [V("Zonnebril", "🕶️"), V("Paraplu", "☂️"), V("Rode pet", "🧢")],
        "aanwijzingen": [
            "Tim was niet in de sporthal en ook niet in de bibliotheek.",
            "Lisa had geen rode pet en geen zonnebril bij zich.",
            "De persoon in de bakkerij droeg een rode pet.",
            "Sam was niet in de bibliotheek.",
            "De persoon met de zonnebril was in de sporthal.",
            "De beker verdween uit de sporthal.",
        ],
        "oplossing": {"Sam": ("Sporthal", "Zonnebril"),
                      "Lisa": ("Bibliotheek", "Paraplu"),
                      "Tim": ("Bakkerij", "Rode pet")},
        "dader": "Sam",
    },
    {
        ...
        "verdachten": [V("Yusuf", "🧑"), V("Mila", "👧"), V("Bram", "👦")],
        "plaatsen": [V("Kantine", "🍽️"), V("Gymzaal", "🤸"), V("Schoolplein", "🏫")],
        "voorwerpen": [V("Blauwe rugzak", "🎒"), V("Koptelefoon", "🎧"), V("Skateboard", "🛹")],
        "aanwijzingen": [
            "Bram was buiten, op het schoolplein.",
            "Mila was niet in de gymzaal.",
            "De persoon met het skateboard was in de gymzaal.",
            "Bram had geen blauwe rugzak bij zich.",
            "Mila droeg geen koptelefoon.",
            "De telefoon verdween uit de kantine.",
        ],
        "oplossing": {"Yusuf": ("Gymzaal", "Skateboard"),
                      "Mila": ("Kantine", "Blauwe rugzak"),
                      "Bram": ("Schoolplein", "Koptelefoon")},
        "dader": "Mila",
    },
    {
        ...
        "verdachten": [V("Roos", "👩"), V("Daan", "🧑"), V("Isa", "👧")],
        "plaatsen": [V("Directiekamer", "🚪"), V("Aula", "🎭"), V("Fietsenstalling", "🚲")],
        "voorwerpen": [V("Sleutelbos", "🔑"), V("Zaklamp", "🔦"), V("Zwarte handschoen", "🧤")],
        "aanwijzingen": [
            "Isa was niet binnen in het schoolgebouw.",
            "De persoon in de directiekamer had een sleutelbos bij zich.",
            "Roos had geen sleutelbos en geen zwarte handschoen.",
            "De persoon met de zaklamp was in de aula.",
            "Daan droeg geen zwarte handschoen.",
            "De laptop verdween uit de directiekamer.",
        ],
        "oplossing": {"Roos": ("Aula", "Zaklamp"),
                      "Daan": ("Directiekamer", "Sleutelbos"),
                      "Isa": ("Fietsenstalling", "Zwarte handschoen")},
        "dader": "Daan",
    },
]
